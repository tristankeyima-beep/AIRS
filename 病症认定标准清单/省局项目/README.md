...
- 同一源表序号实际包含多个独立病种时，可在版本目录下按病种增加一层子目录；每个病种子目录仍固定放一套 `md`、`json`、`html`。
...
当前已维护版本：`v20260517`、`v20260728`；精神病条目已在 `v20260805` 按实际病种拆分。
...
3. 器官移植后抗排异治疗
4. 严重精神障碍（M02111）、其他精神障碍（M02000）；历史版本合并维护为“精神病”
5. 眼内注射治疗黄斑病变
6. 使用特立氟胺治疗多发性硬化症
7. 癫痫
8. 帕金森
