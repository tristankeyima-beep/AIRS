...
def main(certification_list=None, material_list=None, **kwargs) -> dict:
    """
    将认定标准中的 ruleRepository 转换为可迭代的规则数组
    兼容两种入参方式：
    1. main(certification_list={...})
    2. main(certification_list="...")
    3. main({"certification_list": {...}, "material_list": [...]}) 这种平台整体传参方式
    """

    # 兼容：只有包含 certification_list 字段时，才视为平台整体参数 dict。
    # 如果 certification_list 本身就是认定标准对象，必须原样保留。
